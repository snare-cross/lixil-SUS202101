...
<li class="l-spOn"><a href="' + path + '/dataprotection/">個人情報保護に関する原則</a></li>\
...
<li><a href="https://www.facebook.com/lixilcorporation" target="_blank" class="icon-blank"><img src="/common/pic/icon_facebook_f.png" alt="Facebook">Facebookページ</a></li>\
<li><a href="https://www.instagram.com/lixil_official/" target="_blank" class="icon-blank"><img src="/common/pic/icon_instagram_f.png" alt="instagram">Instagramページ</a></li>\
<li><a href="https://twitter.com/lixil_official" target="_blank" class="icon-blank"><img src="/common/pic/icon_twitter_f.png" alt="twitter">Twitterページ</a></li>\
</ul>\
</div>\
...
var pegeTop = '<div id="lxl-footer-pagetop"><a href="' + path + '#lxl-header"><img src="' + path + '/common/pic/btn_pagetop.png" width="60" height="60" alt="ページの先頭へ"></a></div>';
